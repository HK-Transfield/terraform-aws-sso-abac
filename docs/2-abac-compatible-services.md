...
|Amazon OpenSearch A313  Ingestion|
...
## 2.2 Services that Partially work with ABAC
| Service |
|------------------|
|AWS Amplify|
|Amazon CloudFront|
|Amazon CloudWatch Logs|
|AWS CodeBuild<sup>[1](#partial1)</sup>|
|AWS Data Pipeline|
...
|IAM Identity Center OIDC service|
...
|AWS Tax Settings|
|Amazon Textract|
|AWS Tiros API (for Reachability Analyzer)|
|AWS Trusted Advisor|
